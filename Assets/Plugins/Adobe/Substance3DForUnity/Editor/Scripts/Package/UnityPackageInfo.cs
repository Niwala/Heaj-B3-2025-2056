...
namespace Adobe.SubstanceEditor
{
    internal static class UnityPackageInfo
    {
        ...
        private static string IconPath_256 => $"{PathUtils.GetPluginRoot()}/Editor/Assets/Logo_256.png";
        private static string IconPath_128 => $"{PathUtils.GetPluginRoot()}/Editor/Assets/Logo_128.png";
        private static string IconPath_64 = $"{PathUtils.GetPluginRoot()}/Editor/Assets/Logo_64.png";
        private static string IconPath_32 = $"{PathUtils.GetPluginRoot()}/Editor/Assets/Logo_32.png";
