...
namespace Adobe.SubstanceEditor.ProjectSettings
{
    ...
    internal class SubstanceEditorSettingsProvider : SettingsProvider
    {
        ...
        private static string SubstanceAssetLogoPath => $"{PathUtils.GetPluginRoot()}/Editor/Assets/S_3DHeart_18_N_nudged.png";
        private static string SubstanceCommunityAssetLogoPath => $"{PathUtils.GetPluginRoot()}/Editor/Assets/S_3DCummunityAssets_18_N.png";
