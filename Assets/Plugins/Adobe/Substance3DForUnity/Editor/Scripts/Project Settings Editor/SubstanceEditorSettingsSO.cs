...
namespace Adobe.SubstanceEditor.ProjectSettings
{
    ...
    internal class SubstanceEditorSettingsSO : ScriptableObject
    {
        ...
        {
            string settingsFilePath = PathUtils.GetSettingsFilePath();
            var settings = AssetDatabase.LoadAssetAtPath<SubstanceEditorSettingsSO>(settingsFilePath);
        ...
        {
            return File.Exists(PathUtils.GetSettingsFilePath());
        }
